                          ...
                          Alert(
                            ...
                            buttons: [
                              DialogButton(
                                ...
                                onPressed: () async{                                  
                                  var url = Uri.parse("http://${globals.endpoint}/api_hydrant.php?create&jenis=ohb&nomor=${_controller[0].text}&lokasi=${_controller[1].text}&kadaluarsa=${_controller[2].text}");  
                                  try {
                                    final response = await http.get(url).timeout(
                                      const Duration(seconds: 1),
                                      onTimeout: () {
